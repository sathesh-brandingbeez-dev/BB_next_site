...
/* ✅ TOP-RIGHT INSIDE SCREEN VIEW + z-9999 */
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // ✅ moved down from very top -> "screen view top right"
      "fixed top-20 right-4 z-[9999] flex max-h-screen w-full flex-col gap-2 md:max-w-[420px]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring",
      className,
    )}
    toast-close=""
    {...props}
